...
// type QuestionType = 'MULTIPLE_CHOICE' | 'FREE_RESPONSE' | undefined;
...
//                 <h2 className="research-title">{project.name}</h2>
//                 <p className="research-date">Created on: {project.createdAt}</p>
//               </div>
